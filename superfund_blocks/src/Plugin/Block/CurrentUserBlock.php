 ...
 *
 * This block demonstrates dependency injection — injecting Drupal services
 * into your block via the constructor rather than calling \Drupal:: statically.
 *
 * @Block(
 *   id = "superfund_blocks_current_user",
 *   admin_label = @Translation("Current User Info Block"),
 *   category = @Translation("Superfund Blocks"),
 * )
 */
class CurrentUserBlock extends BlockBase implements BlockPluginInterface, ContainerFactoryPluginInterface {
	/**
