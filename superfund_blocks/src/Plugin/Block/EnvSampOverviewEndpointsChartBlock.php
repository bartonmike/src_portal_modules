 ...
 *
 * Displays a Plotly horizontal bar chart of how many samples have zebrafish
 * XY-coordinate data for each endpoint (site-wide, not scoped to a single
 * sample).
 *
 * @Block(
 *   id = "superfund_blocks_env_samp_overview_endpoints_chart",
 *   admin_label = @Translation("Environmental Samples Overview Endpoints Chart"),
 *   category = @Translation("Superfund Blocks"),
 * )
 */
class EnvSampOverviewEndpointsChartBlock extends BlockBase implements BlockPluginInterface, ContainerFactoryPluginInterface {
  ...
  public function build(): array {
    ...
    $chart_id = 'chart-env-samp-overview-endpoints';
    ...
    //      DOMContentLoaded.
    // -------------------------------------------------------------------------
    $descriptor = "<div class='env-samp-overview-endpoints-plot element-descriptor'>"
...
(function init() {
  ...
  var settings    = drupalSettings.superfundBlocks.envSampOverviewEndpoints['{$chart_id}'];
  ...
  function downloadCsv() {
    ...
    a.href     = url;
    a.download = 'env-samp-overview-endpoints.csv';
    a.click();
      ...
      '#attached' => [
        ...
        'html_head' => [
          ...
          [
            ...
            'plotly_cdn_env_samp_overview_endpoints',
          ],
          ...
          [
            ...
            'superfund_env_samp_overview_endpoints_init',
          ],
        ],
      ],
      '#cache' => [
