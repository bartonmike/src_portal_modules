...
/**
 * Provides a Chemical Overview Class chart block.
 *
 * Displays a Plotly pie chart of how many chemicals fall into each
 * chemical_class (site-wide, not scoped to a single chemical).
 *
 * @Block(
 *   id = "superfund_blocks_chem_overview_class_chart",
 *   admin_label = @Translation("Chemical Overview Class Chart"),
 *   category = @Translation("Superfund Blocks"),
 * )
 */
class ChemOverviewClassChartBlock extends BlockBase implements BlockPluginInterface, ContainerFactoryPluginInterface {
  ...
  public function build(): array {
    ...
    $chart_id = 'chart-chem-overview-class';
...
(function init() {
  ...
  var settings = drupalSettings.superfundBlocks.chemOverviewClass['{$chart_id}'];
  ...
  function downloadCsv() {
    ...
    a.href     = url;
    a.download = 'chem-overview-class.csv';
    a.click();
      ...
      '#attached' => [
        ...
        'html_head' => [
          ...
          [
            ...
            'plotly_cdn_chem_overview_class',
          ],
          ...
          [
            ...
            'superfund_chem_overview_class_init',
          ],
        ],
      ],
      '#cache' => [
